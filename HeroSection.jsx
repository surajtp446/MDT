...
const WHATSAPP_NUMBER = '918494907777';
const MESSAGE = 'Hi MDT, I need a quote for a grain processing plant.';
...
export default function FloatingWhatsApp() {
  ...
  return (
    <motion.a
      ...
      aria-label="Chat with MDT on WhatsApp"
      ...
      style={{
        ...
        zIndex: 9990,
        boxShadow: '0 6px 20px rgba(26,23,18,0.18)',
      }}
    >
      <svg
        width="28"
